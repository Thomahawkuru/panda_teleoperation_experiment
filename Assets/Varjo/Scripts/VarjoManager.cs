    ...
    public class VarjoManager : VarjoLayer
    {
        ...
        private new void Awake()
        {
            ...
            if (forceVRSupport)
            {
                ...
                {
                    if (XRSettings.loadedDeviceName != "OpenXR")
                    {
                ...
                {
                    //Debug.LogError("OpenXR is not in the list of supported Virtual Reality SDKs. You need to add it to the list in Player Settings.");
                }
            }
            else
            {
